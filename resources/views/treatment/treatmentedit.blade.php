	                ...
	                <div class="card">
	                    ...
	                    <div class="card-content">
	                        <div class="card-body">
	                            <form class="form">
                        		 @csrf
                        		 	<input type="hidden" name="patientId" id="patientId" value="{{$treatmentDetails->patient_id}}">
	                                ...
	                                <div class="row">
	                                    <div class="col-md-6 col-12">
	                                        <div class="form-group">
	                                            ...
	                                            <input type="text" id="treatment_date" class="form-control dateofbirth"
	                                                value="{{ date('d-M-Y', strtotime($treatmentDetails->treatment_date)) }}" name="treatment_date">
	                                        </div>
	                                    </div>
	                                    <div class="col-md-6 col-12">
	                                        <div class="form-group">
			                                    		...
			                                    		<div class="col-md-6 col-12 d-flex checkboxinputBlock">
					                                        <div class="col-md-4 col-12 col-sm-12 checkboxBlock mb-3">
						                                        <div class="custom-control custom-checkbox">
						                                            <input type="checkbox" class="form-check-input form-check-primary" name="checktreatment[]" id="{{$treatment['id']}}" value="{{$treatment['name']."-".$i}}" @if(isset($TreatmentArr[$treatment['name']])) echo checked @endif >
                                                            ...
                                                            <div class="col-md-4 col-12 col-sm-12 px-2 inputBlock mb-3">
                                                                    <input type="text" class="form-control chargesinput" placeholder="Charges" name="charges[]" value="<?php 
                                                                if(isset($TreatmentArr[$treatment['name']])) {
                                                                    $treatmentObject = $TreatmentArr[$treatment['name']];
                                                                    echo $treatmentObject->charges;  // Access the 'remark' property
                                                                }
                                                                ?>">
                                                            </div>
					                                        <div class="col-md-4 col-12 col-sm-12 inputBlock px-2 mb-3">
                                                                <input type="text" class="form-control" placeholder="Remark" name="remark[]" value="<?php 
                                                                if(isset($TreatmentArr[$treatment['name']])) {
                                                                    $treatmentObject = $TreatmentArr[$treatment['name']];
                                                                    echo $treatmentObject->remark;  // Access the 'remark' property
                                                                }
                                                                ?>">
				                                            </div>
				                                        </div>
	                                    ...
	                                    <div class="col-md-6 col-12">
	                                    	<div class="form-group">
					                            ...
					                            <textarea class="form-control" id="exampleFormControlTextarea1" name="diagnosis" rows="3">{{$treatmentDetails->diagnosis}}</textarea>
			                                </div>
	                                    </div>
    ...
    <script>
		$(document).ready(function() {
		    $("form").submit(function(e){
		    	...
		    	$("#overlay").fadeIn(300);
		    	$.ajax({
		    		url: "{{ route('updateTreatment', [$treatmentDetails->id]) }}",
		    		type: "POST",
		    		data: formData,
		    		dataType: "json", 
	                    ...
	                    if(response.result)
	                    {
	                        Swal.fire({
                              ...
                              showConfirmButton:true
	                            ...
	                            window.location.href = "{{ url('/patientview')."/".$treatmentDetails->patient_id }}";
	                        });
	                    }
	                    else
	                    {
            ...
            <?php
            if (!empty($toothArr)) {
                foreach ($toothArr as $toothValue) {
                    // Check if $toothValue has a value before triggering the click event
                    if (!empty($toothValue)) {
                        echo "$('.teethsection img[data-id=$toothValue]').trigger('click');";
                    }
                }
            }
            ?>
