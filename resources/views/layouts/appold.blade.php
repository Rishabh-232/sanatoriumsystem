                    ...
                    <ul class="menu">
                        ...
                        <li
                            ...
                            <a href="{{ url('ref_treatments') }}" class='sidebar-link'>
                                <i class="fa-fw select-all fas"></i>
                                <span>Reference Treatments</span>
                            </a>
                        </li>

                        <li
                            class="sidebar-item">
                            <a href="{{ url('medicines') }}" class='sidebar-link'>
                                <i class="fa-fw select-all fas"></i>
                                <span>Medicines</span>
                            </a>
                        </li>
                        ...
                        <li
                            class="sidebar-item">
                            <a href="{{ route('laborderlist') }}" class='sidebar-link'>
                                <i class="fa-fw select-all fas"></i>
                                <span>Lab Order</span>
                            </a>
                        </li>
                        ...
                        <li
                            class="sidebar-item">
                            <a href="{{ route('visitlist') }}" class='sidebar-link'>
                                <i class="fa-fw select-all fas"></i>
                                <span>Visit</span>
                            </a>
                        </li>
                        ...
                        <li
                            class="sidebar-item">
                            <a href="{{ route('reportlist') }}" class='sidebar-link'>
                                <i class="fa-fw select-all fas"></i>
                                <span>Report</span>
                            </a>
                        </li>
                        ...
                        <li
                            class="sidebar-item">
                            <a href="{{ route('appontmentlist') }}" class='sidebar-link'>
                                <i class="fa-fw select-all fas"></i>
